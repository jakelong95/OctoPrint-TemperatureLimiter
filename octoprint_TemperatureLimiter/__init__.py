...
class TemperaturelimiterPlugin(octoprint.plugin.SettingsPlugin,
    ...
    def get_assets(self):
        ...
        # core UI here.
        return {
            "js": ["js/TemperatureLimiter.js"],
            "css": ["css/TemperatureLimiter.css"],
            "less": ["less/TemperatureLimiter.less"]
        }
